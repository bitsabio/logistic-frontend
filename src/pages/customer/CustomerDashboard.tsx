  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <header className="border-b border-border bg-card px-6 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            {customer?.company && <span className="text-xs bg-muted rounded px-1.5 py-0.5">{customer.company}</span>}
          </div>
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        <div className="mb-8">
          <h1 className="text-2xl font-semibold text-foreground">Welcome back{customer?.full_name ? `, ${customer.full_name.split(' ')[0]}` : ''}!</h1>
          <p className="text-muted-foreground text-sm mt-1">Your client dashboard is being set up. More features coming soon.</p>
        </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-xl border bg-card p-6 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-0.5">View and track your active orders</p>
            </div>
          </div>
          <div className="rounded-xl border bg-card p-6 flex items-center gap-4">
            <div className="h-12 w-12 rounded-lg bg-orange-500/10 flex items-center justify-center shrink-0">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-0.5">Track real-time delivery status</p>
            </div>
          </div>
        </div>
      </main>
